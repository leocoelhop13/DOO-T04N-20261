...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        // Dados de novos vendedores
        Vendedor vendedor1 = new Vendedor("Joao", 25, loja, "Cascavel", "Centro", "Rua B", 2000);
        Vendedor vendedor2 = new Vendedor("Ana", 28, loja, "Cascavel", "Centro", "Rua C", 2200);

        // Dados de novos clientes
        Cliente cliente1 = new Cliente("Maria", 30, "Cascavel", "Centro", "Rua D");
        Cliente cliente2 = new Cliente("Carlos", 35, "Cascavel", "Centro", "Rua E");

        // Adiciona vendedores ao array da loja que trabalham
        loja.vendedores.add(vendedor1);
        loja.vendedores.add(vendedor2);

        // Adiciona os clientes ao array da loja que frequenta
